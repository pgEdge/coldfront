...
detach on each peer over a dblink
(`coldfront._detach_partition_peers`). This is **outside the modelled
protocol entirely**: it touches no Iceberg catalog, takes no claim, and
